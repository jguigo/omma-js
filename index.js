...
const receitas = [
   {
      ...
      link: "https://www.youtube.com/watch?v=Mxc3RQE4yAg&feature=emb_title",
      vegan: true,
   },
];
    let id = 2
function cadastrarReceita(nome, dificuldade, ingredientes, preparo, link, vegan){
    receitas.push({
        id,
        nome,
        dificuldade,
...
cadastrarReceita('Cachorro quente', 'Simples', ['Pão de leite', 'Salsicha', 'Molhos', 'Um monte de coisa boa'], 'Pega o pão e joga tudo dentro', 'youtube.com.br', false );
